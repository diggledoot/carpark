...
public class UseCaseConfig {
	...
	@Bean
	public IngestCarParkInfoCsv ingestCarParkInfoCsv(CarParkInfoRepository carParkInfoRepository) {
		return new IngestCarParkInfoCsv(carParkInfoRepository);
	}

	@Bean
	public GetCarParkAvailability getCarParkAvailability(CarParkAvailabilityRepository carParkAvailabilityRepository,
	...
	public GetNearestAvailableCarParks getNearestAvailableCarParks(
			CarParkAvailabilityRepository carParkAvailabilityRepository, CarParkInfoRepository carParkInfoRepository) {
