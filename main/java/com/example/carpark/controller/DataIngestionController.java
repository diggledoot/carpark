...
public class DataIngestionController {
    ...
    @Operation(
            summary = "Ingest car park info CSV",
            description = "Ingests car park information from a CSV file into the system."
    )
    ...
    @Operation(
            summary = "Pull car park availability data",
            description = "Pull car park availability from SG Gov API"
    )
